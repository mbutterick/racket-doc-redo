352
((3) 0 () 1 ((q lib "net/win32-ssl.rkt")) () (h ! (equal) ((c def c (c (? . 0) q win32-ssl-abandon-port)) q (463 . 3)) ((c def c (c (? . 0) q win32-ssl-available?)) q (1025 . 2)) ((c def c (c (? . 0) q win32-ssl-connect)) q (0 . 12)) ((c def c (c (? . 0) q win32-ssl-port?)) q (964 . 3)) ((c def c (c (? . 0) q ports->win32-ssl-ports)) q (563 . 10))))
procedure
